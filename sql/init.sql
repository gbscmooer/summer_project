...
CREATE TABLE IF NOT EXISTS t_user (
    ...
    perm_post      TINYINT NOT NULL DEFAULT 1 COMMENT '1-可发帖 0-禁止',
    perm_comment   TINYINT NOT NULL DEFAULT 1 COMMENT '1-可留言/评论/私信 0-禁止',
    perm_order     TINYINT NOT NULL DEFAULT 1 COMMENT '1-可下单 0-禁止',
    perm_broadcast TINYINT NOT NULL DEFAULT 1 COMMENT '1-可广播系统通知 0-禁止',
